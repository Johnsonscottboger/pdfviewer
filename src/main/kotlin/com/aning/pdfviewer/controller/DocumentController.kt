...
import com.aning.pdfviewer.model.MessageResult
...
public class DocumentController {
     ...
     */
    @PostMapping("/add")
    public fun add(@RequestBody document: Document): MessageResult {
        //this._documentService.add(User(), document);
        return MessageResult(true, "添加成功");
    }
}